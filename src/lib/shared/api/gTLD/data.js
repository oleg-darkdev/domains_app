const data = [
  {
    ...
    notes: [
      ...
      `"This domain is intended as the miscellaneous TLD for organizations that ddefaultPrice: 0, introduced: '', stats: '', multiplier: 1, idn't fit anywhere else. Some non-government organizations may fit here."[8][9] While mainly non-profits have used this domain, it was never restricted from miscellaneous use.`,
