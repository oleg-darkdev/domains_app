const data = [
  ...
  },
  {
    ...
    notes: [
      `Australian territory: not to be confused with Cocos Island in Guam.`,
      `Currently marketed as global domain, registration allowed worldwide, local presence not required; the domain is currently operated by eNIC, a VeriSign company.`,
      `It is administered by a United States company, VeriSign, through a subsidiary company, eNIC, which promotes it for international registration as "the next .com". The .cc domain was originally assigned to eNIC in October 1997 by the IANA; eNIC manages the TLD alongside SamsDirect Internet.`,
  ...
  },
  {
    ...
    notes: [
      ...
      `It was created in 1997 as a replacement for the .zr (Zaire) ccTLD, which was phased out and eventually deleted in 2001.`,
  ...
  },
  {
    ...
    notes: [
      ...
      `The domain was made available for registration free of charge on Freenom's website, regardless of whether the individual who registers the domain has any connection with the Central African Republic.`,
      `Exceptions include "high value" domain names, which include trademark domain names for most Fortune 500 companies, and common dictionary terms. Potentially valuable domains which are fewer than 4 characters were also marked "High Value". The same applies to other domains offered via Freenom, such as .tk and .ml. `,
  ...
  },
  {
    ...
    notes: [
      ...
      `Made available in 1987,[2] only two years after .com, it is administered by SWITCH Information Technology Services.`,
  ...
  },
  {
    ...
    notes: [
      `Non-resident domain applications cost €222.00 (EUR) for a minimum of 2 years, and must be renewed every 2 years thereafter.`,
  ...
  },
  {
    ...
    notes: [
      `The domain is the largest ccTLD in the world.`,
  ...
  },
  {
    ...
    notes: [
      `It was created following the decision on December 15, 2010 by the ISO 3166 Maintenance Agency to allocate CW as the ISO 3166-1 alpha-2 code for Curaçao.[2] This decision followed Curaçao's new status as an autonomous country within the Kingdom of the Netherlands on October 10, 2010.`,
      `The University of Curaçao, which already was the sponsor for .an was designated as the sponsoring organization. Registration of .cw domains was available from 1 February 2012.`,
  ...
  },
  {
    ...
    notes: [
      ...
      `The Christmas Island Internet Administration is a community-owned non-profit company which also provides Internet service to the island's residents. .cx is a member of the Council of Country Code Administrators, a group of country-code domains making use of common registry and/or dispute resolution services. `,
